...
contains
 ...
 ! ************************************************************************************************
 ! public subroutine read_force4chm: read in forcing data
 ! ************************************************************************************************
 subroutine read_force4chm(istep,iFile,iRead,ncid,time_data,forcStruct,err,message)
 ...
 ! *************************************************************************
 subroutine readForcingData4chm(currentJulday,ncId,iFile,iRead,nHRUlocal,time_data,forcStruct,err,message)
 USE netcdf                                            ! netcdf capability
 USE time_utils_module,only:compcalday                 ! convert julian day to calendar date
 USE time_utils_module,only:compJulday                 ! convert calendar date to julian day
 ...
 end subroutine readForcingData4chm


end module read_force4chm_module
